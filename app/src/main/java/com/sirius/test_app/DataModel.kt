...
class DataModel(
    val image: String = "https://i.ibb.co/g3YVWD2/img-background.png", // val image: String = "https://ibb.co/37KzF03"
    val logo: String = "https://i.ibb.co/Pjf2B69/img-logo.png", //  val logo: String = "https://ibb.co/GpbZg5t"
    ...
    val reviews: List<ReviewModel> = listOf(
        ReviewModel(
            userImage = "https://i.ibb.co/55HSwqy/img-user-1.png", // userImage = "https://ibb.co/WcJMjSw"
        ...
        ReviewModel(
            userImage = "https://i.ibb.co/j8t3zGZ/img-user-2.png", // userImage = "https://ibb.co/p1q4QZr"
